...
public class TAristas extends LinkedList<TArista> {
    ...
    public TAristas copiarAristasOrdenadas() {
        TAristas aristasNuevas = new TAristas();
        Comparator<TArista> comparador = Comparator.comparingDouble(TArista::getCosto);
        Collections.sort(aristasNuevas, comparador);
